DROP FUNCTION IF EXISTS task4.country_get_summary_list;
CREATE FUNCTION task4.country_get_summary_list(
    in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.country_get_summary_list.sql
**		Name: task4.country_get_summary_list
...
DECLARE
    FN_NAME CONSTANT TEXT := 'task4.country_get_summary_list';
    STEP_INDEX INTEGER;
