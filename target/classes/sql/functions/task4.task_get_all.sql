DROP FUNCTION IF EXISTS task4.task_get_all;
CREATE FUNCTION task4.task_get_all(
  in_login_id BIGINT
)
RETURNS TABLE (
  task_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.task_get_all.sql
**		Name: task4.task_get_all
**		Desc: Get tasks data
*******************************************************************************
**		Auth: botir
**		Date: 2021-08-19
...
DECLARE
  FN_NAME CONSTANT TEXT := 'task4.task_get_all';
  STEP_INDEX INTEGER;
