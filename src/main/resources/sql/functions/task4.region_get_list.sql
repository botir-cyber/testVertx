DROP FUNCTION IF EXISTS task4.region_get_list;
CREATE FUNCTION task4.region_get_list(
  in_login_id BIGINT,
  in_skip BIGINT,
  in_page_size BIGINT
)
...
AS $$
/******************************************************************************
**		File: task4.region_get_list.sql
**		Name: task4.region_get_list
...
DECLARE
  FN_NAME CONSTANT TEXT := 'task4.region_get_list';
  STEP_INDEX INTEGER;
