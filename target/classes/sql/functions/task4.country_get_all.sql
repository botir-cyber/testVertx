DROP FUNCTION IF EXISTS task4.country_get_all;
CREATE FUNCTION task4.country_get_all(
  in_login_id BIGINT
)
RETURNS TABLE (
  country_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.country_get_all.sql
**		Name: task4.country_get_all
...
DECLARE
  FN_NAME CONSTANT TEXT := 'task4.country_get_all';
  STEP_INDEX INTEGER;
