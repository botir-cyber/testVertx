DROP FUNCTION IF EXISTS task4.task_get_summary_list;
CREATE FUNCTION task4.task_get_summary_list(
    in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.task_get_summary_list.sql
**		Name: task4.task_get_summary_list
**		Desc: Get tasks data
*******************************************************************************
**		Auth: botir
**		Date: 2021-08-19
...
DECLARE
    FN_NAME CONSTANT TEXT := 'task4.task_get_summary_list';
    STEP_INDEX INTEGER;
