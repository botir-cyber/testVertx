...
-- DROP TABLE task4.country;

CREATE TABLE IF NOT EXISTS task4.country (
    country_id BIGSERIAL NOT NULL,
    CONSTRAINT pk_task4_country_country_id PRIMARY KEY (country_id)
);

ALTER TABLE task4.country
ADD COLUMN IF NOT EXISTS country_name TEXT,
ADD COLUMN IF NOT EXISTS region BIGINT,
