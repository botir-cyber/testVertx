DROP FUNCTION IF EXISTS task4.job_get_summary_list;
CREATE FUNCTION task4.job_get_summary_list(
    in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.job_get_summary_list.sql
**		Name: task4.job_get_summary_list
**		Desc: Get jobs data
*******************************************************************************
**		Auth: botir
**		Date: 2021-08-19
...
DECLARE
    FN_NAME CONSTANT TEXT := 'task4.job_get_summary_list';
    STEP_INDEX INTEGER;
