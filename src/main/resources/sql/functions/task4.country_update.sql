DROP FUNCTION IF EXISTS task4.country_update;
CREATE FUNCTION task4.country_update(
  in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.country_update.sql
**		Name: task4.country_update
...
DECLARE
  FN_NAME CONSTANT TEXT := 'task4.country_update';
  STEP_INDEX INTEGER;
