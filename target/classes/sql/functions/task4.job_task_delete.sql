DROP FUNCTION IF EXISTS task4.job_task_delete;
CREATE FUNCTION task4.job_task_delete(
  in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task4.job_task_delete.sql
**		Name: task4.job_task_delete
...
DECLARE
  FN_NAME CONSTANT TEXT := 'task4.job_task_delete';
  STEP_INDEX INTEGER;
